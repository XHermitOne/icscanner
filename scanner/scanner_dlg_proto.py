...
class icScannerDlgProto ( wx.Dialog ):
	...
	def __init__( self, parent ):
		...
		self.scanner_comboBox = wx.combo.BitmapComboBox( self.option_panel, wx.ID_ANY, wx.EmptyString, wx.DefaultPosition, wx.DefaultSize, "", wx.CB_READONLY ) 
		...
		self.source_comboBox = wx.combo.BitmapComboBox( self.option_panel, wx.ID_ANY, u"Combo!", wx.DefaultPosition, wx.DefaultSize, "", wx.CB_READONLY ) 
		...
		self.mode_comboBox = wx.combo.BitmapComboBox( self.option_panel, wx.ID_ANY, u"Combo!", wx.DefaultPosition, wx.DefaultSize, "", wx.CB_READONLY ) 
		...
		self.pagesize_comboBox = wx.combo.BitmapComboBox( self.area_panel, wx.ID_ANY, u"Combo!", wx.DefaultPosition, wx.Size( 100,-1 ), "", wx.CB_READONLY ) 
		...
		self.fileext_comboBox = wx.combo.BitmapComboBox( self.extend_panel, wx.ID_ANY, u"Combo!", wx.DefaultPosition, wx.Size( 100,-1 ), "", wx.CB_READONLY ) 
...
class icLoadSheetsDlgProto ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Загрузка листов в лоток", pos = wx.DefaultPosition, size = wx.DefaultSize, style = wx.DEFAULT_DIALOG_STYLE )
...
class icVerifyScanDlgProto ( wx.Dialog ):
	...
	def __init__( self, parent ):
		wx.Dialog.__init__ ( self, parent, id = wx.ID_ANY, title = u"Проверка результата сканирования", pos = wx.DefaultPosition, size = wx.DefaultSize, style = wx.DEFAULT_DIALOG_STYLE )
